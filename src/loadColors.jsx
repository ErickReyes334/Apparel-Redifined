/*updated 12/10/2022*/
function loadColors (posX, posY, lblSize, lblFont) {
    ...
    cmykColor.cyan = 0; // Adjust these values as needed
    cmykColor.magenta = 0;
    cmykColor.yellow = 0;
    cmykColor.black = 100;
    ...
    borderColor.cyan = 0; // Adjust these values as needed
...
function loadColorChips() {
    ...
    ColorChips.prototype.draw = function (isHorizontal, position) {
        ...
        for (var i = 0; i < self.colors.length; i++) {
            ...
            // var rect = doc.pathItems.ellipse(y, x, chipWidth, chipHeight);
